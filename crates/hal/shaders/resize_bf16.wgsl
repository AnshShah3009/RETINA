...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let src_width_f = u32(params.src_w) - 1.0;
    let src_height_f = u32(params.src_h) - 1.0;
    let dst_width_f = u32(params.dst_w) - 1.0;
    let dst_height_f = u32(params.dst_h) - 1.0;

    let src_x_f = u32(x_dst) * src_width_f / dst_width_f;
    let src_y_f = u32(y_dst) * src_height_f / dst_height_f;
    ...
    let dx = src_x_f - u32(x0);
    let dy = src_y_f - u32(y0);
